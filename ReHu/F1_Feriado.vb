...
#Region "METODOS PRIVADOS"
    Private Sub _prIniciarTodo()
        ...
        Calendario.CalendarDimensions = New System.Drawing.Size(4, 3)
        _PMIniciarTodo()
...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("pfnumi", True, "COD", 70))
        listEstCeldas.Add(New Modelo.Celda("pfflib", True, "FECHA", 70))
        listEstCeldas.Add(New Modelo.Celda("pfdes", True, "DESCRIPCION", 200))
        listEstCeldas.Add(New Modelo.Celda("pffact", False))
        listEstCeldas.Add(New Modelo.Celda("pfhact", False))
        listEstCeldas.Add(New Modelo.Celda("pfuact", False))
