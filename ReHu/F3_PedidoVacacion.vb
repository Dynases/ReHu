...
#Region "Metodos Privados"
    ...
    Private Sub _PLimpiarCalendario()
        ...
        Next
        Dim SegundoMes As New Date(Tb_FechaSalida.Value.Year, Tb_FechaSalida.Value.Month + 1, 1)
        Dim a As Integer
        For a = 1 To 31
            Dim dia As DayLabel = Calendario.GetDay(SegundoMes)
            If Not dia Is Nothing Then
                dia.TextAlign = eLabelPartAlignment.MiddleLeft
                dia.Tooltip = ""
                dia.BackgroundStyle.BackColor = Color.White
            End If
            SegundoMes = DateAdd(DateInterval.Day, 1, SegundoMes)
        Next
    ...
    Private Sub _PMostrarRegistro(_N As Integer)
        ...
        With _Dsencabezado.Tables(0).Rows(_N)
            ...
            JMc_Persona.Text = .Item("pgcper").ToString()
            ...
            Dim dia As DayLabel
            Dim Aux As Date = Tb_FechaSalida.Value
            Dim Aux2 As Date = Tb_FechaIngreso.Value
            Dim con As Integer = Tb_DiasPedidos.Value
            Dim pos As Integer
            For i = 0 To con - 1
                If Aux.DayOfWeek <> 6 And Aux.DayOfWeek <> 0 Then
                    dia = Calendario.GetDay(Aux)
                    If Not dia Is Nothing Then
                        dia.BackgroundStyle.BackColor = Color.LightGreen
                        Aux = DateAdd(DateInterval.Day, 1, Aux)
                    End If
                Else
                    i = i - 1
                    Aux = DateAdd(DateInterval.Day, 1, Aux)
    ...
    Private Sub _PCargarBuscador()
        ...
        With JGr_Buscador.RootTable.Columns("pgfdoc")
            ...
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        End With
        With JGr_Buscador.RootTable.Columns("pgest")
            .Caption = "Fecha"
            .Visible = False
            .Width = 70
            .HeaderAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        End With
        With JGr_Buscador.RootTable.Columns("pgobs")
            .Caption = "Observacion"
            .Width = 120
            .HeaderAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        End With
        With JGr_Buscador.RootTable.Columns("pgfsal")
            .Caption = "Salida"
            .Width = 90
            .HeaderAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        End With
        With JGr_Buscador.RootTable.Columns("pgfing")
            .Caption = "Ingreso"
            .Width = 90
            .HeaderAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        End With
        With JGr_Buscador.RootTable.Columns("pgdias")
            .Caption = "Dias"
            .Width = 70
            .HeaderAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
...
#End Region
    ...
    Private Sub _PCargarFeriadosAlCalendario()
        ...
        For i = 0 To dtFechas.Rows.Count - 1
            ...
            Dim dia As DayLabel = Calendario.GetDay(fecha)
            If Not dia Is Nothing Then
                dia.Image = Image.FromFile("D:\Proyecto Dino\ReHu\ReHu\Resources\FERIADO.png")
