...
#Region "PERSONAL"
    ...
    Public Shared Function L_prGrabarPersonal(ByRef _numi As String, _estado As String, _tipoDoc As String, _nroDoc As String,
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@panumi", _numi))
        _listParam.Add(New Datos.DParametro("@paestado", _estado))
        _listParam.Add(New Datos.DParametro("@patipodoc", _tipoDoc))
        _listParam.Add(New Datos.DParametro("@panrodoc", _nroDoc))
        _listParam.Add(New Datos.DParametro("@pafnac", _fnac))
        _listParam.Add(New Datos.DParametro("@pafingreso", _fing))
        ...
        _listParam.Add(New Datos.DParametro("@pafot", _img))
        _listParam.Add(New Datos.DParametro("@paafp", _afp))
        _listParam.Add(New Datos.DParametro("@palat", _lat))
        _listParam.Add(New Datos.DParametro("@palongi", _longi))
        _listParam.Add(New Datos.DParametro("@paaux1", 0))
        _listParam.Add(New Datos.DParametro("@paaux2", ""))
        _listParam.Add(New Datos.DParametro("@paaux3", 0))
        _listParam.Add(New Datos.DParametro("@pauact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@Personal11", "", Contrato))
        ...
        _listParam.Add(New Datos.DParametro("@Personal16", "", Documentos))
    ...
    Public Shared Function L_prModificarPersonal(ByRef _numi As String, _estado As String, _tipoDoc As String, _nroDoc As String,
                                              ...
                                              Descuentos As DataTable, Documentos As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Return _resultado
    End Function
    Public Shared Function L_prPersonalGeneral() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prPersonalDetalleContrato(_numi As String, Optional _Cadena As String = "") As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prPersonalDetalleFamilia(_numi As String, Optional _Cadena As String = "") As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prPersonalDetalleCargo(_numi As String, Optional _Cadena As String = "") As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prPersonalDetalleSueldos(_numi As String, Optional _Cadena As String = "") As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prPersonalDetalleDocumentos(_numi As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "PARÁMETROS"
    ...
    '' PESTAÑA DESCUENTOS
    Public Shared Function L_prEliminarDescuento(_numi As String, ByRef _mensaje As String) As Boolean

        Dim _resultado As Boolean

        If L_fnbValidarEliminacion(_numi, "Descuento", "danumi", _mensaje) = True Then
            Dim _Tabla As DataTable

            Dim _listParam As New List(Of Datos.DParametro)

            _listParam.Add(New Datos.DParametro("@tipo", -1))
            _listParam.Add(New Datos.DParametro("@danumi", _numi))
        ...
        Return _resultado
    End Function
    Public Shared Function L_prGrabarDescuento(ByRef _numi As String, _tipo As String, _tipoMonto As String, _monto As String,
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@danumi", _numi))
        _listParam.Add(New Datos.DParametro("@datipo", _tipo))
        _listParam.Add(New Datos.DParametro("@datipomonto", _tipoMonto))
        _listParam.Add(New Datos.DParametro("@damonto", _monto))
        _listParam.Add(New Datos.DParametro("@daobs", _obs))
        ...
        Return _resultado
    End Function
    Public Shared Function L_prModificarDescuento(ByRef _numi As String, _tipo As String, _tipoMonto As String, _monto As String,
                                              _obs As String, _finicio As String, _venc As String, _fvenc As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
